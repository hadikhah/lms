    ...
    <main id="index">
        ...
        <div class="bt-1-top">
            <div class="container">
                <div class="tutor">
                    <div class="tutor-item">
                        <div class="tutor-avatar">
                            <span class="tutor-image" id="tutor-image">
                                <img src="{{ $user->thumb }}" class="tutor-avatar-img"></span>
                    ...
                    <div class="tutor-item">
                        <div class="stat">
                            <span class="tutor-number tutor-count-courses">{{ count($user->courses) }} </span>
                            <span class="">تعداد دوره ها</span>
                        </div>
                        <div class="stat">

                            <span class="tutor-number">{{ $user->studentsCount() }} </span>
        ...
        <div class="container">
            <div class="box-filter">
                ...
                <div class="posts">
                    @foreach($user->courses as $courseItem)
