    ...
    <main id="single">
        ...
        <div class="main-row container">
            <div class="sidebar-right">
                <div class="sidebar-sticky">
                    ...
                    <div class="course-teacher-details">
                        <div class="top-part">
                            <a href="{{ route('singleTutor', $course->teacher) }}">
                    ...
                    @include('Home::layout.sidebar-banners')
            ...
            <div class="content-left">
                ...
                @include('Home::layout.episodes-list')
            </div>
        </div>
        ...
        @include("Home::comments.index", ["commentable" => $course])
    </main>
@endsection
