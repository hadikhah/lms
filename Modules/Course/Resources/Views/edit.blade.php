        ...
        <div class="col-12 bg-white">
            ...
            <form action="{{ route('courses.update', $course->id) }}" class="padding-30" method="post"
                ...
                <x-select name="type" required>
                    ...
                    @foreach(\Modules\Course\Models\Course::$types as $type)
                        <option value="{{ $type }}"
                ...
                <x-select name="status" required>
                    ...
                    @foreach(\Modules\Course\Models\Course::$statuses as $status)
                        <option value="{{ $status }}"
                ...
                <br>
                <button class="btn btn-info">بروزرسانی دوره</button>
            </form>
        </div>
    </div>
@endsection
