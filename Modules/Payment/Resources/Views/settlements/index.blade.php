    ...
    <div class="main-content">
        <div class="tab__box">
            <div class="tab__items">
                ...
                <a class="tab__item " href="?status={{ \Modules\Payment\Models\Settlement::STATUS_SETTLED }}">تسویه های واریز شده</a>
        ...
        <div class="table__box">
            <table class="table">
                ...
                <tr role="row" class="title-row">
                    ...
                    <th>مبلغ (تومان )</th>
                    <th>وضعیت</th>
                    @can(\Modules\RolePermissions\Models\Permission::PERMISSION_MANAGE_SETTLEMENTS)
                    <th>عملیات</th>
                    @endcan
                </tr>
                </thead>
