    ...
    <div class="col-4 bg-white">
        ...
        <form action="{{ route("discounts.update", $discount->id) }}" method="post" class="padding-30">
            ...
            <div class="notificationGroup">
                <input id="discounts-field-1" class="discounts-field-pn" name="type" value="all" type="radio" {{ $discount->type == \Modules\Discount\Models\Discount::TYPE_ALL ? "checked" : "" }}/>
                <label for="discounts-field-1">همه دوره ها</label>
            </div>
            <div class="notificationGroup">
                <input id="discounts-field-2" class="discounts-field-pn" name="type" value="special" type="radio" {{ $discount->type == \Modules\Discount\Models\Discount::TYPE_SPECIAL ? "checked" : "" }}/>
                <label for="discounts-field-2">دوره خاص</label>
            </div>
            <div id="selectCourseContainer" class="{{ $discount->type == \Modules\Discount\Models\Discount::TYPE_ALL ? "d-none" : "" }}">
