...
@section('content')
    @can(\Modules\RolePermissions\Models\Permission::PERMISSION_TEACH)
            ...
            <table width="100%" class="table">
                ...
                @foreach($payments as $payment)
                    <tr role="row" class="">
                        ...
                        <td class="@if($payment->status == \Modules\Payment\Models\Payment::STATUS_SUCCESS) text-success @else text-error @endif">@lang($payment->status)</td>
                    </tr>
                @endforeach
                </tbody>
            </table>
